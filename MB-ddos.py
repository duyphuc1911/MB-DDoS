...
(___)(___)(___)  `.__.                `.__,'    `.__,'    `.__.'    '.___.'   
                                                                               ...
                                                                               ''')
print ("Author             : MOBEIEMI")
print ("Author Github      : https://github.com/duyphuc1911")
print ("My server discord  : https://discord.gg/MhgshXWzXE")
print ( "code by mobeiemi for better stresser")
print ("version 4.0")
print("-"*50)
logger = getLogger("mobeiemi")
